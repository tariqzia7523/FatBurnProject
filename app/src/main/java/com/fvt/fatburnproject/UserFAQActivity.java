...
public class UserFAQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_f_a_q);
        getSupportActionBar().hide();
        recyclerView=findViewById(R.id.faq_list);
        faqModels=new ArrayList<>();
        recyclerView=findViewById(R.id.faq_list);
        recyclerView.setNestedScrollingEnabled(false);
        recyclerView.setLayoutManager(new LinearLayoutManager(UserFAQActivity.this));
        myAdapter=new MyAdapter(getApplicationContext(),UserFAQActivity.this,faqModels);
        recyclerView.setAdapter(myAdapter);
        progressDialog=new ProgressDialog(UserFAQActivity.this);
...
//                @Override
//                public void onClick(View v) {
//                    Intent intent=new Intent(activity, FAQUserDetailActivity.class);
